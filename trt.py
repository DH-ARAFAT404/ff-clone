...
def gmail():
		...
		clear()
		print('\033[1;37m example: ARAFAT, ali, sajjad, faizan\033[1;97m')
		linex()
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
     ...
     print('\033[1;37m----------------------------------------------')
     print(" WHATS APP : 01749953660")
      
      input('\033[1;37m Press Enter For Contact To Admin ')
      tks = ('Hello%20MR-ARAFAT%20Sir%20!%20Please%20Approve%20My%20Key%20The%20TRT%20Key%20Is%20:%20'+id)
      time.sleep(1)
      approval()
  except:
    sys.exit()
